...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "메이플 디스코드", "메이플스토리 커뮤니티", "메이플 종합 디스코드",
    "메이플봇", "메이플 캐릭터 조회",
    "메이플 거래방", "메이플스토리 거래방", "메이플랜드 거래방", "메이플플래닛 거래방",
    "메이플 아이템 거래", "메이플 메소 거래", "메이플 거래 디스코드",
    "메이플 홍보", "메이플 디스코드 홍보", "메이플 길드 홍보", "메이플 캐릭터 홍보",
    "메이플 파티 모집", "메이플스토리 파티 구인", "메이플 공대 모집", "메이플 파티",
    "메이플플래닛", "메이플플래닛 커뮤니티", "메이플플래닛 파티 모집", "메이플플래닛 길드 모집",
    "메이플플래닛 거래", "메이플플래닛 메소 거래", "메이플플래닛 아이템 거래",
    "메이플플래닛 공략", "메이플플래닛 보스", "메이플플래닛 채팅",

...
export default function DevPage() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex gap-2 flex-wrap justify-center mb-8">
                <span className="text-xs font-bold px-3.5 py-1.5 rounded-full border" style={{ color: "#f59e0b", borderColor: "#f59e0b" }}>🍁 메이플스토리</span>
                <span className="text-xs font-bold px-3.5 py-1.5 rounded-full border" style={{ color: "#22c55e", borderColor: "#22c55e" }}>🌿 메이플랜드</span>
                <span className="text-xs font-bold px-3.5 py-1.5 rounded-full border" style={{ color: "#a855f7", borderColor: "#a855f7" }}>🪐 메이플플래닛</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 mb-10 w-full max-w-md">
                <div className="flex flex-col items-center gap-1 px-3 py-4 rounded-2xl border border-gray-200">
                  <p className="text-2xl md:text-3xl font-black text-gray-900 leading-none">50,000+</p>
                ...
                <div className="flex flex-col items-center gap-2 px-3 py-5 rounded-2xl border border-gray-200">
                  <div className="flex flex-col items-center gap-0.5 mb-1 h-14 justify-center">
                    ...
                    <span className="text-sm font-black leading-tight" style={{ color: "#22c55e" }}>🌿 메이플랜드</span>
                    <span className="text-sm font-black leading-tight" style={{ color: "#a855f7" }}>🪐 메이플플래닛</span>
                  </div>
                  <p className="text-2xl md:text-3xl font-black text-gray-900 leading-none">3개</p>
                ...
                <div className="flex flex-col items-center gap-2 px-3 py-5 rounded-2xl border border-gray-200">
                  ...
                  <p className="text-2xl md:text-3xl font-black text-gray-900 leading-none">24/7</p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link
                  href="/notice"
                  className="flex items-center gap-2 font-semibold px-7 py-3.5 rounded-xl text-base text-gray-700 border border-gray-300 transition-all duration-200 hover:bg-gray-50"
                >
                  공지사항 보기
                </Link>
              </div>
      ...
      {/* ── 게임별 채널 소개 ── */}
      <section className="max-w-4xl mx-auto px-4 py-20 border-t border-gray-100">
        <p className="text-center text-xs font-bold tracking-widest text-purple-500 uppercase mb-3">GAMES</p>
        <h2 className="text-2xl md:text-3xl font-black text-center mb-3 text-gray-900">어떤 게임을 하세요?</h2>
        <p className="text-center text-sm text-gray-400 mb-10">게임별 전용 채널을 운영하고 있어요</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {GAMES.map((g) => (
            <div key={g.name} className="rounded-2xl border p-5 flex flex-col gap-4" style={{ borderColor: g.border + "44" }}>
              ...
              <a
                ...
                style={{ color: g.color, borderColor: g.border + "66" }}
              >
                채널 입장하기 →
              </a>
            </div>
      ...
      {/* ── 서버 특징 ── */}
      <section className="max-w-4xl mx-auto px-4 pb-20 border-t border-gray-100">
        <div className="pt-20">
          <p className="text-center text-xs font-bold tracking-widest text-purple-500 uppercase mb-3">FEATURES</p>
          <h2 className="text-2xl md:text-3xl font-black text-center mb-10 text-gray-900">메이플디스코드에서 할 수 있는 것</h2>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-20 border-t border-gray-100">
        <div className="pt-20">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-center mb-2 text-gray-900">메이플봇 명령어</h2>
                ...
                <div className="px-6 py-5 border-b border-gray-100 flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap mb-1.5">
                      <code className="font-black text-base px-2 py-0.5 rounded-lg border" style={{ color: cmd.color, borderColor: cmd.color + "44" }}>
                        {cmd.name}
                      </code>
                      <span className="text-xs font-semibold px-2 py-0.5 rounded-full border" style={{ color: cmd.color, borderColor: cmd.color + "44" }}>
                        {cmd.badge}
                      </span>
                    </div>
      ...
      <section className="border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-24 text-center">
          <div className="flex justify-center gap-2 flex-wrap mb-6">
            {GAMES.map(g => (
              <span key={g.name} className="text-xs font-bold px-3 py-1 rounded-full border" style={{ color: g.color, borderColor: g.border + "66" }}>
                {g.icon} {g.name}
              </span>
            ))}
          </div>

      ...
      <div className="flex items-center gap-4">
        {user ? (
          <div className="flex items-center gap-3 bg-gray-800 px-4 py-1.5 rounded-full border border-gray-700">
            ...
            <button onClick={handleLogout} className="text-xs font-bold text-orange-500 hover:text-orange-400">
              로그아웃
            </button>
          </div>
        ) : (
          <div className="flex gap-2">
            <Link href="/login" className="bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded text-xs font-bold transition">
              로그인
            </Link>

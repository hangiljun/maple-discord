...
export const metadata: Metadata = {
  ...
  description:
    "메이플봇 슬래시 커맨드 전체 목록. /정보, /링크, /유니온, /연무장 명령어로 메이플스토리 캐릭터·링크스킬·유니온·무릉도장 정보를 조회하세요.",
...
const COMMANDS: Command[] = [
  {
    name: "/정보",
    usage: "/정보 캐릭터명",
    desc: "메이플스토리 캐릭터의 기본 정보를 조회합니다. 결과 하단 버튼으로 장비, 헥사, 코디, 레벨 변동, 캐릭터 역사, 무릉도장 기록까지 확인할 수 있어요.",
    badge: "캐릭터",
    badgeColor: "#f59e0b",
    features: [
      ...
      { icon: "🥊", text: "연무장 — 무릉도장 최고 층수 및 클리어 시간" },
    ],
    example: "/정보 아크메이지",
  },
  {
  ...
  },
  {
    name: "/연무장 랭킹",
    usage: "/연무장 랭킹 [난이도] [월드]",
    desc: "무릉도장(연무장) 랭킹을 조회합니다. 난이도와 월드는 선택 옵션이에요.",
    badge: "무릉도장",
    badgeColor: "#f97316",
    features: [

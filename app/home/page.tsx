...
const FEATURES = [
  {
    icon: "🤖",
    title: "메이플봇",
    desc: "캐릭터 정보, 링크스킬, 유니온을 슬래시 커맨드 하나로 조회. 공식 Nexon API 연동.",
  },
  {
    icon: "🔒",
    title: "인증 거래 시스템",
...
const COMMANDS = [
  ...
  },
  {
    ...
    example: "/정보 아크메이지",
    features: ["🛡️ 장비 슬롯별 목록 및 잠재 옵션", "📈 최근 7일 경험치 · 30일 레벨 히스토리", "💎 헥사 코어 및 헥사 스탯", "🎨 캐릭터 코디 및 역사 조회"],
  },
  {
    name: "/링크",
    badge: "링크스킬",
    ...
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <section className="max-w-4xl mx-auto px-4 pb-8">
        <div className="border-t border-white/10 pt-10 text-center space-y-3">
          ...
          <p className="text-sm text-[#475569] leading-relaxed">
            메이플플래닛 전용 채널에서는 메이플플래닛 유저들끼리 파티 모집, 길드 모집, 아이템·메소 거래,
            공략 정보 공유를 자유롭게 진행할 수 있습니다. 메이플플래닛 디스코드를 찾고 있다면
            메이플디스코드에서 함께하세요.
          </p>
          <p className="text-sm text-[#475569] leading-relaxed">
            메이플 아이템 거래방, 메소 거래, 길드 홍보, 캐릭터 홍보, 파티 모집까지
            메이플러에게 필요한 모든 채널을 하나의 디스코드 서버에서 운영합니다.
          </p>
        </div>
      </section>
